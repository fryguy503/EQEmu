...
#ifndef EQEMU_BASE_CHARACTER_ACHIEVEMENT_REWARDS_REPOSITORY_H
#define EQEMU_BASE_CHARACTER_ACHIEVEMENT_REWARDS_REPOSITORY_H

#include "../../database.h"
#include "../../strings.h"
#include <ctime>

class BaseCharacterAchievementRewardsRepository {
public:
	struct CharacterAchievementRewards {
	...
	{
		return std::string("character_achievement_rewards");
	}
	...
	static CharacterAchievementRewards NewEntity()
	{
		CharacterAchievementRewards e{};
	...
	static CharacterAchievementRewards GetCharacterAchievementRewards(
		const std::vector<CharacterAchievementRewards> &character_achievement_rewardss,
		int character_achievement_rewards_id
	)
	{
		for (auto &character_achievement_rewards : character_achievement_rewardss) {
			if (character_achievement_rewards.character_id == character_achievement_rewards_id) {
				return character_achievement_rewards;
			}
		}
	...
	static CharacterAchievementRewards FindOne(
		Database& db,
		int character_achievement_rewards_id
	)
	{
		auto results = db.QueryDatabase(
			fmt::format(
				...
				BaseSelect(),
				PrimaryKey(),
				character_achievement_rewards_id
			)
		);
	...
	static int UpdateOne(
		Database& db,
		const CharacterAchievementRewards &e
	)
	{
	...
	static CharacterAchievementRewards InsertOne(
		Database& db,
		CharacterAchievementRewards e
	)
	{
	...
	static int InsertMany(
		Database& db,
		const std::vector<CharacterAchievementRewards> &entries
	)
	{
	...
	static std::vector<CharacterAchievementRewards> All(Database& db)
	{
		std::vector<CharacterAchievementRewards> all_entries;
	...
	static std::vector<CharacterAchievementRewards> GetWhere(Database& db, const std::string &where_filter)
	{
		std::vector<CharacterAchievementRewards> all_entries;
...
#endif //EQEMU_BASE_CHARACTER_ACHIEVEMENT_REWARDS_REPOSITORY_H
